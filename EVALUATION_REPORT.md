...
*   **Functional Testing**: Every core feature (Onboarding, Scrollytelling, Candidate Explorer, Voter Recovery, AI Chat) has been internally validated through multiple browser simulation passes.
...
*   **Cognitive Support**: The Scrollytelling engine breaks complex legal processes into simple, visual chunks to reduce cognitive load.
